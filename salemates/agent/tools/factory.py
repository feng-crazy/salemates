...
from salemates.agent.tools.image import ImageGenerationTool
from salemates.agent.tools.message import MessageTool
from salemates.agent.tools.ov_file import (
    VikingReadTool,
    VikingListTool,
    VikingSearchTool,
    VikingGrepTool,
...
if TYPE_CHECKING:
    from salemates.agent.tools.spawn import SpawnTool
