...
from salemates.sandbox.base import SandboxBackend, SandboxDisabledError, UnsupportedBackendError
from salemates.sandbox.backends import get_backend


from salemates.config.schema import SandboxConfig, SessionKey, Config
...
class SandboxManager:
    ...
    async def _copy_bootstrap_files(self, sandbox_workspace: Path) -> None:
        ...
        from salemates.agent.skills import BUILTIN_SKILLS_DIR
        import shutil
