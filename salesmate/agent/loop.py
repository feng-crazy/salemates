...
from salesmate.agent.subagent import SubagentManager
from salesmate.agent.tools import register_default_tools
from salesmate.agent.tools.registry import ToolRegistry
from salesmate.bus.events import InboundMessage, OutboundMessage, OutboundEventType
from salesmate.bus.queue import MessageBus
from salesmate.config import load_config
from salesmate.config.schema import Config
from salesmate.config.schema import SessionKey
from salesmate.hooks import HookContext
from salesmate.hooks.manager import hook_manager
...
from salesmate.utils.helpers import cal_str_tokens
from salesmate.utils.tracing import trace
...
class AgentLoop:
    ...
    def __init__(
        ...
        Example:
            ...
            ... )
        """
        from salesmate.config.schema import ExecToolConfig
