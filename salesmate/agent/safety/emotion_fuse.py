...
Example:
    >>> from salesmate.agent.emotion import EmotionResult, CustomerEmotion
...
if TYPE_CHECKING:
    from salesmate.agent.safety.human_handoff import HumanHandoffManager
...
class EmotionFuse:
    ...
    async def check_with_handoff(
        ...
        if result.action.requires_human and handoff_manager:
            from salesmate.agent.safety.human_handoff import HandoffTrigger
