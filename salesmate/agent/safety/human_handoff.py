...
from salesmate.agent.models.customer import CustomerProfile, SalesStage
...
class HumanHandoffManager:
    ...
    # Redis key prefixes
    PAUSE_KEY_PREFIX = "salesmate:handoff:pause:"
    STATE_KEY_PREFIX = "salesmate:handoff:state:"
