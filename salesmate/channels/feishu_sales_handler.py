...
- Routing messages through SalesMate agent loop
...
from salesmate.channels.feishu_cards import (
    BANTFormCard,
    MeetingScheduleCard,
    ProductComparisonCard,
    QuoteCard,
)
from salesmate.config.schema import FeishuChannelConfig
...
class FeishuSalesHandler(FeishuChannel):
    ...
    - Integration with SalesMate agent loop
    """
