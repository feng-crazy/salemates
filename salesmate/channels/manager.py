...
from salesmate.config.schema import BaseChannelConfig, ChannelType, Config
        ...
        **additional_deps,
        ...
        try:
            ...
            if channel_config.type == ChannelType.TELEGRAM:
                from salesmate.channels.telegram import TelegramChannel
                ...
                from salesmate.channels.feishu import FeishuChannel
                ...
                from salesmate.channels.discord import DiscordChannel
                ...
                from salesmate.channels.whatsapp import WhatsAppChannel
                ...
                from salesmate.channels.mochat import MochatChannel
                ...
                from salesmate.channels.dingtalk import DingTalkChannel
                ...
                from salesmate.channels.email import EmailChannel
                ...
                from salesmate.channels.slack import SlackChannel
                ...
                from salesmate.channels.qq import QQChannel
