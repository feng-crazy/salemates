...
from salesmate.config.schema import TelegramChannelConfig
from salesmate.channels.utils import extract_image_paths, read_image_file
    ...
    async def _on_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        if media_file and self._app:
            try:
                ...
                from salesmate.utils.helpers import get_media_path
                ...
                if media_type == "voice" or media_type == "audio":
                    from salesmate.providers.transcription import GroqTranscriptionProvider
