...
from salesmate.config.loader import load_config, save_config, get_config_path
from salesmate.config.schema import Config, ChannelType, SandboxBackend, SandboxMode
...
def create_dashboard_tab():
    with gr.Tab("Dashboard"):
        from salesmate import __version__
...
def create_console_app(bus=None, config=None):
    ...
    if bus is not None and config is not None:
        try:
            from salesmate.channels.openapi import get_openapi_router
