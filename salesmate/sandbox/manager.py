...
from salesmate.sandbox.base import SandboxBackend, SandboxDisabledError, UnsupportedBackendError
from salesmate.sandbox.backends import get_backend


from salesmate.config.schema import SandboxConfig, SessionKey, Config
...
class SandboxManager:
    ...
    async def _copy_bootstrap_files(self, sandbox_workspace: Path) -> None:
        ...
        from salesmate.agent.skills import BUILTIN_SKILLS_DIR
        import shutil
