...
Connect with customers across 50+ platforms including:
- Feishu
- WeChat
- Email
- SMS
...
| Plan | Price | Features |
|------|-------|----------|
| Starter | $299/month | Basic features, 5 users |
| Pro | $999/month | Full features, 20 users |
...
- B2B enterprises with sales teams
- Mid-market companies looking to scale
- Sales organizations seeking automation